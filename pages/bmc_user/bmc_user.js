Page({
  ...
  save: function () {
    wx.setStorageSync('todo_list_user', this.data.todos)
    wx.setStorageSync('todo_logs_user', this.data.logs)
  },

  load: function () {
    var todos = wx.getStorageSync('todo_list_user')
    if (todos) {
    ...
    var logs = wx.getStorageSync('todo_logs_user')
    if (logs) {
