Page({
  ...
  save: function () {
    wx.setStorageSync('todo_list_team', this.data.todos)
    wx.setStorageSync('todo_logs_team', this.data.logs)
  },

  load: function () {
    var todos = wx.getStorageSync('todo_list_team')
    if (todos) {
    ...
    var logs = wx.getStorageSync('todo_logs_team')
    if (logs) {
