Page({
  ...
  save: function () {
    wx.setStorageSync('todo_list_t', this.data.todos)
    wx.setStorageSync('todo_logs_t', this.data.logs)
  },

  load: function () {
    var todos = wx.getStorageSync('todo_list_t')
    if (todos) {
    ...
    var logs = wx.getStorageSync('todo_logs_t')
    if (logs) {
