Page({
  ...
  save: function () {
    wx.setStorageSync('todo_list_value', this.data.todos)
    wx.setStorageSync('todo_logs_value', this.data.logs)
  },

  load: function () {
    var todos = wx.getStorageSync('todo_list_value')
    if (todos) {
    ...
    var logs = wx.getStorageSync('todo_logs_value')
    if (logs) {
