Page({
  ...
  save: function () {
    wx.setStorageSync('todo_list_o', this.data.todos)
    wx.setStorageSync('todo_logs_o', this.data.logs)
  },

  load: function () {
    var todos = wx.getStorageSync('todo_list_o')
    if (todos) {
    ...
    var logs = wx.getStorageSync('todo_logs_o')
    if (logs) {
